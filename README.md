...
Most recently, support of the Whisper large-v3 turbo-model for faster-whisper was added in the faster-whisper-turbo-branch: [faster-whisper-turbo](https://github.com/InaKrapp/whisper-locally-running/tree/faster-whisper-turbo). This was enabled thanks to the conversion of the whisper-turbo-model to a CTranslate2 model on Huggingface by deepdml: [faster-whisper-turbo-model](https://huggingface.co/deepdml/faster-whisper-large-v3-turbo-ct2)
