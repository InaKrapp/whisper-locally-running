...
Speaker recognition (diarization) is enabled thanks to the project whisperX by Max Bain: [whisperX]([https://github.com/SYSTRAN/faster-whisper](https://github.com/m-bain/whisperX))
